<x-app-layout>
    ...
    <div class="container mx-auto mt-8 px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            <div class="p-6">
                <h1 class="text-xl font-semibold text-gray-900">{{ isset($product_category) ? 'Edit' : 'Create' }} Product Category</h1>
            </div>
            ...
            <form action="{{ isset($product_category) ? route('product-categories.update', $product_category->id) : route('product-categories.store') }}" method="POST" class="divide-y divide-gray-200">
                ...
                <div class="px-6 py-4 space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ isset($product_category) ? $product_category->name : old('name') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" value="{{ isset($product_category) ? $product_category->slug : old('slug') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ isset($product_category) ? $product_category->meta_title : old('meta_title') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" value="{{ isset($product_category) ? $product_category->meta_keywords : old('meta_keywords') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
