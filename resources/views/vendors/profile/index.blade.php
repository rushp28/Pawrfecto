                            ...
                            <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-md">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <x-input id="mobile_number" name="mobile_number" type="text" class="block w-full mt-1" value="{{ old('mobile_number', $vendor->phone_number) }}" autocomplete="mobile-number" required maxlength="10" />
